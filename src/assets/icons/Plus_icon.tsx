...
const Plus_icon: FC<TProps> = ({ containerStyle, backgroundColor, onPress }, props) => {
    return (
        <TouchableOpacity
            onPress={onPress}
